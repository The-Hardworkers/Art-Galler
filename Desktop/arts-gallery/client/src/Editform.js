...
const Editform = () => {
  ...
  const edit = () => {
    axios
      .put(`http://localhost:8000/api/painting/${id}`, {
  ...
  useEffect(() => {
    console.log(id)
    axios
      .get(`http://localhost:8000/api/painting/${id}`)
      .then((res) => {
      ...
      <form class="pa4 black-80">
        <div class="measure center">
          ...
          {loading ? (
            ...
            <img className="settingimage" src={image} />
          )}
          ...
          <div class="">
            ...
            <Link to={`/`}><button class="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib"><span> Cancel </span></button></Link> 
          </div>
        </div>
      </form>
    </div>
